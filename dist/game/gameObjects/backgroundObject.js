...
var backgroundObject = /*#__PURE__*/function (_GameObject) {
  _inherits(backgroundObject, _GameObject);

  var _super = _createSuper(backgroundObject);
  ...
  function backgroundObject(scene) {
    ...
    _this.parent.gameState['backgroundObject01'] = {};
    _this.gameState = _this.parent.gameState['backgroundObject01'];
    _this.gameState = {
      x: 0,
      y: 1
    };
