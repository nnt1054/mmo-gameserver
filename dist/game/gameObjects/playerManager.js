...
var playerManagerObject = /*#__PURE__*/function (_GameObject) {
  _inherits(playerManagerObject, _GameObject);

  var _super = _createSuper(playerManagerObject);

  function playerManagerObject(scene) {
    var _this;

    _classCallCheck(this, playerManagerObject);

    _this = _super.call(this, scene);
    _this.scene = scene;
    _this.update = _this.update.bind(_assertThisInitialized(_this));
    _this.draw = _this.draw.bind(_assertThisInitialized(_this));
    _this.gameState = _this.parent.gameState['playerManager'] = {};
    _this.connectedPlayers = [];
    _this.count = 0;
    return _this;
  }

  _createClass(playerManagerObject, [{
    key: "update",
